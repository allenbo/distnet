...
conv_conv_comm_cost = {
    ...
    (sisw, disw_b): lambda input_size, weight_size, overlapping, n: 2.0 * (input_size/n * (n-1) + weight_size * (n-1)),
    (sisw, disw_i): lambda input_size, weight_size, overlapping, n: 2.0 * (input_size/n * (n-1) + weight_size * (n-1) + overlapping),
    ...
    (sidw, disw_b): lambda input_size, weight_size, overlapping, n: 2.0 * (input_size/(n*n) * (n-1) * 2 + weight_size * (n-1)),
    (sidw, disw_i): lambda input_size, weight_size, overlapping, n: 2.0 * (input_size/(n*n) * (n-1) * 2 + overlapping * 2 + weight_size * (n-1)),
    ...
    (disw_b, disw_i): lambda input_size, weight_size, overlapping, n: 2.0 * (input_size/(n*n) * (n-1) * 2 + overlapping * 2 + weight_size * (n-1)), 
    ...
    (disw_i, disw_b): lambda input_size, weight_size, overlapping, n: 2.0 * (input_size/(n*n) * (n-1) * 2 + weight_size * (n-1)),
    (disw_i, disw_i): lambda input_size, weight_size, overlapping, n: 2.0 * (overlapping * 2 + weight_size * (n-1))
    }

conv_fc_comm_cost = {
    (sisw, sisw): lambda input_size, weight_size, o, n: 0,
    (sisw, sidw_f): lambda input_size, weight_size, o, n: 2.0 * input_size * (n-1),
    (sisw, disw_b): lambda input_size, weight_size, o, n: 2.0 * (input_size/n * (n-1) + weight_size * (n-1)),
    ...
    (sidw, disw_b): lambda input_size, weight_size, o, n: 2.0 * (input_size/(n*n) * (n-1) + weight_size * (n-1)),
    ...
    (disw_i, disw_b): lambda input_size, weight_size, o, n: 2.0 * (input_size/(n*n) * (n-1) * 2 + weight_size * (n-1))
    }
...
fc_fc_comm_cost = {
    ...
    (sidw_f, disw_b): lambda input_size, weight_size, o, n: 2.0 * (input_size/(n*n) * (n-1) * 2 + weight_size * (n-1)),
