...
//void convWeightActs(Blob& input, Blob& ingrad, Blob& weight_grad, int image_y, int output_y, int output_x, int filter_size, int padding, int stride, int color, int num_group, int partial_sum);
