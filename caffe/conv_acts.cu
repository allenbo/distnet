...
//        (float)1., weight_data + weight_offset * g, col_data + col_offset * g, //        (float)0., top_data + top.offset(n) + top_offset * g);
//    }
//  }
//}
...
//    int image_y, int output_y, int output_x,
//    int filter_size, int padding, int stride, int color, int group, int partial_sum)
//{
//  const float* ingrad_data = ingrad.gpu_data();
